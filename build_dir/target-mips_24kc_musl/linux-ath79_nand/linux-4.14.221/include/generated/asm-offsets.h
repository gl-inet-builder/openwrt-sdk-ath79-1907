...
#define TASK_PID 480 /* offsetof(struct task_struct, pid) */
#define TASK_STACK_CANARY 488 /* offsetof(struct task_struct, stack_canary) */
...
#define THREAD_REG16 1048 /* offsetof(struct task_struct, thread.reg16) */
#define THREAD_REG17 1052 /* offsetof(struct task_struct, thread.reg17) */
#define THREAD_REG18 1056 /* offsetof(struct task_struct, thread.reg18) */
#define THREAD_REG19 1060 /* offsetof(struct task_struct, thread.reg19) */
#define THREAD_REG20 1064 /* offsetof(struct task_struct, thread.reg20) */
#define THREAD_REG21 1068 /* offsetof(struct task_struct, thread.reg21) */
#define THREAD_REG22 1072 /* offsetof(struct task_struct, thread.reg22) */
#define THREAD_REG23 1076 /* offsetof(struct task_struct, thread.reg23) */
#define THREAD_REG29 1080 /* offsetof(struct task_struct, thread.reg29) */
#define THREAD_REG30 1084 /* offsetof(struct task_struct, thread.reg30) */
#define THREAD_REG31 1088 /* offsetof(struct task_struct, thread.reg31) */
#define THREAD_STATUS 1092 /* offsetof(struct task_struct, thread.cp0_status) */
#define THREAD_FPU 1096 /* offsetof(struct task_struct, thread.fpu) */
#define THREAD_BVADDR 1424 /* offsetof(struct task_struct, thread.cp0_badvaddr) */
#define THREAD_BUADDR 1428 /* offsetof(struct task_struct, thread.cp0_baduaddr) */
#define THREAD_ECODE 1432 /* offsetof(struct task_struct, thread.error_code) */
#define THREAD_TRAPNO 1436 /* offsetof(struct task_struct, thread.trap_nr) */

#define THREAD_FPR0 1096 /* offsetof(struct task_struct, thread.fpu.fpr[0]) */
#define THREAD_FPR1 1104 /* offsetof(struct task_struct, thread.fpu.fpr[1]) */
#define THREAD_FPR2 1112 /* offsetof(struct task_struct, thread.fpu.fpr[2]) */
#define THREAD_FPR3 1120 /* offsetof(struct task_struct, thread.fpu.fpr[3]) */
#define THREAD_FPR4 1128 /* offsetof(struct task_struct, thread.fpu.fpr[4]) */
#define THREAD_FPR5 1136 /* offsetof(struct task_struct, thread.fpu.fpr[5]) */
#define THREAD_FPR6 1144 /* offsetof(struct task_struct, thread.fpu.fpr[6]) */
#define THREAD_FPR7 1152 /* offsetof(struct task_struct, thread.fpu.fpr[7]) */
#define THREAD_FPR8 1160 /* offsetof(struct task_struct, thread.fpu.fpr[8]) */
#define THREAD_FPR9 1168 /* offsetof(struct task_struct, thread.fpu.fpr[9]) */
#define THREAD_FPR10 1176 /* offsetof(struct task_struct, thread.fpu.fpr[10]) */
#define THREAD_FPR11 1184 /* offsetof(struct task_struct, thread.fpu.fpr[11]) */
#define THREAD_FPR12 1192 /* offsetof(struct task_struct, thread.fpu.fpr[12]) */
#define THREAD_FPR13 1200 /* offsetof(struct task_struct, thread.fpu.fpr[13]) */
#define THREAD_FPR14 1208 /* offsetof(struct task_struct, thread.fpu.fpr[14]) */
#define THREAD_FPR15 1216 /* offsetof(struct task_struct, thread.fpu.fpr[15]) */
#define THREAD_FPR16 1224 /* offsetof(struct task_struct, thread.fpu.fpr[16]) */
#define THREAD_FPR17 1232 /* offsetof(struct task_struct, thread.fpu.fpr[17]) */
#define THREAD_FPR18 1240 /* offsetof(struct task_struct, thread.fpu.fpr[18]) */
#define THREAD_FPR19 1248 /* offsetof(struct task_struct, thread.fpu.fpr[19]) */
#define THREAD_FPR20 1256 /* offsetof(struct task_struct, thread.fpu.fpr[20]) */
#define THREAD_FPR21 1264 /* offsetof(struct task_struct, thread.fpu.fpr[21]) */
#define THREAD_FPR22 1272 /* offsetof(struct task_struct, thread.fpu.fpr[22]) */
#define THREAD_FPR23 1280 /* offsetof(struct task_struct, thread.fpu.fpr[23]) */
#define THREAD_FPR24 1288 /* offsetof(struct task_struct, thread.fpu.fpr[24]) */
#define THREAD_FPR25 1296 /* offsetof(struct task_struct, thread.fpu.fpr[25]) */
#define THREAD_FPR26 1304 /* offsetof(struct task_struct, thread.fpu.fpr[26]) */
#define THREAD_FPR27 1312 /* offsetof(struct task_struct, thread.fpu.fpr[27]) */
#define THREAD_FPR28 1320 /* offsetof(struct task_struct, thread.fpu.fpr[28]) */
#define THREAD_FPR29 1328 /* offsetof(struct task_struct, thread.fpu.fpr[29]) */
#define THREAD_FPR30 1336 /* offsetof(struct task_struct, thread.fpu.fpr[30]) */
#define THREAD_FPR31 1344 /* offsetof(struct task_struct, thread.fpu.fpr[31]) */
#define THREAD_FCR31 1352 /* offsetof(struct task_struct, thread.fpu.fcr31) */
#define THREAD_MSA_CSR 1356 /* offsetof(struct task_struct, thread.fpu.msacsr) */
