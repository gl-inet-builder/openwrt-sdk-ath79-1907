...
enum opt_code
{
  ...
  OPT_fhonour_copts = 696,                   /* -fhonour-copts */
  ...
  OPT_finhibit_size_directive = 707,         /* -finhibit-size-directive */
  OPT_finit_character_ = 708,                /* -finit-character= */
  OPT_finit_derived = 709,                   /* -finit-derived */
  ...
  OPT_finline_matmul_limit_ = 720,           /* -finline-matmul-limit= */
  ...
  OPT_fipa_bit_cp = 729,                     /* -fipa-bit-cp */
  ...
  OPT_fkeep_gc_roots_live = 757,             /* -fkeep-gc-roots-live */
  ...
  OPT_fkeep_static_functions = 761,          /* -fkeep-static-functions */
  ...
  OPT_flifetime_dse_ = 766,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 767,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 768,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 769,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 770,                    /* -flocal-ivars */
  /* OPT_floop_block = 771, */               /* -floop-block */
  /* OPT_floop_flatten = 772, */             /* -floop-flatten */
  /* OPT_floop_interchange = 773, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 774,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 775, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 776,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 777, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 778, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 779,                      /* -flra-remat */
  OPT_flto = 780,                            /* -flto */
  OPT_flto_compression_level_ = 781,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 782,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 783,                 /* -flto-partition= */
  OPT_flto_report = 784,                     /* -flto-report */
  OPT_flto_report_wpa = 785,                 /* -flto-report-wpa */
  OPT_flto_ = 786,                           /* -flto= */
  OPT_fltrans = 787,                         /* -fltrans */
  OPT_fltrans_output_list_ = 788,            /* -fltrans-output-list= */
  OPT_fmath_errno = 789,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 790,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 791,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 792,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 793,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 794,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 795,                     /* -fmem-report */
  OPT_fmem_report_wpa = 796,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 797,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 798,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 799,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 800,                /* -fmessage-length= */
  OPT_fmodule_private = 801,                 /* -fmodule-private */
  OPT_fmodulo_sched = 802,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 803,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 804,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 805,                  /* -fms-extensions */
  /* OPT_fmudflap = 806, */                  /* -fmudflap */
  /* OPT_fmudflapir = 807, */                /* -fmudflapir */
  /* OPT_fmudflapth = 808, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 809, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 810, */                  /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 811,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 812,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 813,                   /* -fnext-runtime */
  OPT_fnil_receivers = 814,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 815,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 816,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 817, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 818,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 819,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 820,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 821,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 822,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 823,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 824,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 825,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 826,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 827,                   /* -foffload-abi= */
  OPT_foffload_ = 828,                       /* -foffload= */
  OPT_fomit_frame_pointer = 829,             /* -fomit-frame-pointer */
  OPT_fopenacc = 830,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 831,                   /* -fopenacc-dim= */
  ...
  OPT_foptimize_strlen = 839,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 840, */           /* -foptional-diags */
  OPT_fpack_derived = 841,                   /* -fpack-derived */
  OPT_fpack_struct = 842,                    /* -fpack-struct */
  OPT_fpack_struct_ = 843,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 844,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 845,              /* -fpcc-struct-return */
  OPT_fpch_deps = 846,                       /* -fpch-deps */
  OPT_fpch_preprocess = 847,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 848,                     /* -fpeel-loops */
  OPT_fpeephole = 849,                       /* -fpeephole */
  OPT_fpeephole2 = 850,                      /* -fpeephole2 */
  OPT_fpermissive = 851,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 852,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 853,                            /* -fpic */
  OPT_fpie = 854,                            /* -fpie */
  OPT_fplan9_extensions = 855,               /* -fplan9-extensions */
  OPT_fplt = 856,                            /* -fplt */
  OPT_fplugin_arg_ = 857,                    /* -fplugin-arg- */
  OPT_fplugin_ = 858,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 859,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 860,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 861,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 862,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 863,                   /* -fpreprocessed */
  OPT_fpretty_templates = 864,               /* -fpretty-templates */
  OPT_fprintf_return_value = 865,            /* -fprintf-return-value */
  ...
  OPT_fprofile_update_ = 874,                /* -fprofile-update= */
  ...
  OPT_freorder_blocks_algorithm_ = 899,      /* -freorder-blocks-algorithm= */
  ...
  OPT_frtti = 912,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 913,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_trace_pc = 914,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 915,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 916,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 917,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 918,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 919,                      /* -fsanitize= */
  OPT_fsched_critical_path_heuristic = 920,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 921,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 922,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 923,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 924,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 925,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 926,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 927,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 928,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 929,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 930,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 931,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 932,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 933,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 934,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 935,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 936,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 937, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 938,                /* -fschedule-fusion */
  OPT_fschedule_insns = 939,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 940,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 941,              /* -fsecond-underscore */
  OPT_fsection_anchors = 942,                /* -fsection-anchors */
  /* OPT_fsee = 943, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 944,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 945,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 946, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 947,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 948,          /* -fselective-scheduling2 */
  OPT_fself_test_ = 949,                     /* -fself-test= */
  OPT_fsemantic_interposition = 950,         /* -fsemantic-interposition */
  OPT_fshort_enums = 951,                    /* -fshort-enums */
  OPT_fshort_wchar = 952,                    /* -fshort-wchar */
  OPT_fshow_column = 953,                    /* -fshow-column */
  OPT_fshrink_wrap = 954,                    /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 955,           /* -fshrink-wrap-separate */
  OPT_fsign_zero = 956,                      /* -fsign-zero */
  OPT_fsignaling_nans = 957,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 958,               /* -fsigned-bitfields */
  OPT_fsigned_char = 959,                    /* -fsigned-char */
  OPT_fsigned_zeros = 960,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 961,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 962,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 963,             /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 964,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 965,                    /* -fsplit-loops */
  OPT_fsplit_paths = 966,                    /* -fsplit-paths */
  OPT_fsplit_stack = 967,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 968,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 969, */                 /* -fsquangle */
  OPT_fssa_backprop = 970,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 971,                     /* -fssa-phiopt */
  OPT_fsso_struct_ = 972,                    /* -fsso-struct= */
  OPT_fstack_arrays = 973,                   /* -fstack-arrays */
  /* OPT_fstack_check = 974, */              /* -fstack-check */
  OPT_fstack_check_ = 975,                   /* -fstack-check= */
  OPT_fstack_limit = 976,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 977,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 978,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 979,                /* -fstack-protector */
  OPT_fstack_protector_all = 980,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 981,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 982,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 983,                   /* -fstack-reuse= */
  OPT_fstack_usage = 984,                    /* -fstack-usage */
  OPT_fstats = 985,                          /* -fstats */
  OPT_fstdarg_opt = 986,                     /* -fstdarg-opt */
  OPT_fstore_merging = 987,                  /* -fstore-merging */
  /* OPT_fstrength_reduce = 988, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 989,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 990,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 991,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 992, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 993,      /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 994, */        /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 995,             /* -fstrong-eval-order= */
  OPT_fsync_libcalls = 996,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 997,                    /* -fsyntax-only */
  OPT_ftabstop_ = 998,                       /* -ftabstop= */
  /* OPT_ftail_call_workaround = 999, */     /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1000,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1001, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1002,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1003, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1004,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1005,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1006,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1007, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1008,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1009,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1010,                   /* -ftime-report */
  OPT_ftime_report_details = 1011,           /* -ftime-report-details */
  ...
  OPT_ftrampolines = 1017,                   /* -ftrampolines */
  OPT_ftrapping_math = 1018,                 /* -ftrapping-math */
  OPT_ftrapv = 1019,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1020,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1021,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1022,                      /* -ftree-ccp */
  OPT_ftree_ch = 1023,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1024, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1025,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1026,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1027, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1028,                   /* -ftree-cselim */
  OPT_ftree_dce = 1029,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1030,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1031,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1032,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1033,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1034, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1035,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1036,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1037, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1038,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1039,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1040, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1041,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1042,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1043,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1044,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1045,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1046,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1047,                      /* -ftree-pre */
  OPT_ftree_pta = 1048,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1049,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1050, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1051,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1052,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1053,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1054,                     /* -ftree-slsr */
  OPT_ftree_sra = 1055,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1056, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1057, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1058,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1059,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1060,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1061, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1062,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1063, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1064,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1065,         /* -funconstrained-commons */
  OPT_funderscoring = 1066,                  /* -funderscoring */
  OPT_funit_at_a_time = 1067,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1068,              /* -funroll-all-loops */
  OPT_funroll_loops = 1069,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1070, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1071,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1072,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1073,                 /* -funsigned-char */
  OPT_funswitch_loops = 1074,                /* -funswitch-loops */
  OPT_funwind_tables = 1075,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1076,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1077,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1078,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1079,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1080,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1081,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1082,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1083,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1084,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1085,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1086, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1087,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1088,                   /* -fverbose-asm */
  /* OPT_fversion = 1089, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1090,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1091,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1092,                   /* -fvisibility= */
  OPT_fvpt = 1093,                           /* -fvpt */
  /* OPT_fvtable_gc = 1094, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1095, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1096,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1097,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1098,                     /* -fvtv-debug */
  OPT_fweak = 1099,                          /* -fweak */
  OPT_fweb = 1100,                           /* -fweb */
  /* OPT_fwhole_file = 1101, */              /* -fwhole-file */
  OPT_fwhole_program = 1102,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1103,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1104,             /* -fworking-directory */
  OPT_fwpa = 1105,                           /* -fwpa */
  OPT_fwpa_ = 1106,                          /* -fwpa= */
  OPT_fwrapv = 1107,                         /* -fwrapv */
  /* OPT_fxref = 1108, */                    /* -fxref */
  /* OPT_fzee = 1109, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1110,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1111,                     /* -fzero-link */
  OPT_g = 1112,                              /* -g */
  OPT_gant = 1113,                           /* -gant */
  OPT_gcoff = 1114,                          /* -gcoff */
  OPT_gcolumn_info = 1115,                   /* -gcolumn-info */
  ...
  OPT_gno_column_info = 1123,                /* -gno-column-info */
  OPT_gno_pubnames = 1124,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1125,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1126,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1127,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1128,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1129,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1130,                   /* -gsplit-dwarf */
  OPT_gstabs = 1131,                         /* -gstabs */
  OPT_gstabs_ = 1132,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1133,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1134,                        /* -gtoggle */
  OPT_gvms = 1135,                           /* -gvms */
  OPT_gxcoff = 1136,                         /* -gxcoff */
  OPT_gxcoff_ = 1137,                        /* -gxcoff+ */
  OPT_gz = 1138,                             /* -gz */
  OPT_gz_ = 1139,                            /* -gz= */
  OPT_h = 1140,                              /* -h */
  OPT_idirafter = 1141,                      /* -idirafter */
  OPT_imacros = 1142,                        /* -imacros */
  OPT_imultiarch = 1143,                     /* -imultiarch */
  OPT_imultilib = 1144,                      /* -imultilib */
  OPT_include = 1145,                        /* -include */
  OPT_iplugindir_ = 1146,                    /* -iplugindir= */
  OPT_iprefix = 1147,                        /* -iprefix */
  OPT_iquote = 1148,                         /* -iquote */
  OPT_iremap = 1149,                         /* -iremap */
  OPT_isysroot = 1150,                       /* -isysroot */
  OPT_isystem = 1151,                        /* -isystem */
  OPT_iwithprefix = 1152,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1153,              /* -iwithprefixbefore */
  OPT_k8 = 1154,                             /* -k8 */
  OPT_l = 1155,                              /* -l */
  OPT_lang_asm = 1156,                       /* -lang-asm */
  OPT_mabi_ = 1157,                          /* -mabi= */
  OPT_mabicalls = 1158,                      /* -mabicalls */
  OPT_mabs_ = 1159,                          /* -mabs= */
  OPT_mandroid = 1160,                       /* -mandroid */
  OPT_march_ = 1161,                         /* -march= */
  OPT_mbionic = 1162,                        /* -mbionic */
  OPT_mbranch_cost_ = 1163,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1164,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1165,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1166,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1167,             /* -mcompact-branches= */
  OPT_mdebug = 1168,                         /* -mdebug */
  OPT_mdebugd = 1169,                        /* -mdebugd */
  OPT_mdivide_breaks = 1170,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1171,                  /* -mdivide-traps */
  OPT_mdmx = 1172,                           /* -mdmx */
  OPT_mdouble_float = 1173,                  /* -mdouble-float */
  OPT_mdsp = 1174,                           /* -mdsp */
  OPT_mdspr2 = 1175,                         /* -mdspr2 */
  OPT_meb = 1176,                            /* -meb */
  OPT_mel = 1177,                            /* -mel */
  OPT_membedded_data = 1178,                 /* -membedded-data */
  OPT_meva = 1179,                           /* -meva */
  OPT_mexplicit_relocs = 1180,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1181,                  /* -mextern-sdata */
  OPT_mfix_24k = 1182,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1183,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1184,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1185,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1186,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1187,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1188,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1189,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1190,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1191,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1192,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1193,                 /* -mfp-exceptions */
  OPT_mfp32 = 1194,                          /* -mfp32 */
  OPT_mfp64 = 1195,                          /* -mfp64 */
  OPT_mfpxx = 1196,                          /* -mfpxx */
  OPT_mframe_header_opt = 1197,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1198, */              /* -mfused-madd */
  OPT_mglibc = 1199,                         /* -mglibc */
  OPT_mgp32 = 1200,                          /* -mgp32 */
  OPT_mgp64 = 1201,                          /* -mgp64 */
  OPT_mgpopt = 1202,                         /* -mgpopt */
  OPT_mhard_float = 1203,                    /* -mhard-float */
  OPT_mimadd = 1204,                         /* -mimadd */
  OPT_minterlink_compressed = 1205,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1206,              /* -minterlink-mips16 */
  OPT_mips = 1207,                           /* -mips */
  OPT_mips16 = 1208,                         /* -mips16 */
  OPT_mips3d = 1209,                         /* -mips3d */
  OPT_mllsc = 1210,                          /* -mllsc */
  OPT_mload_store_pairs = 1211,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1212,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1213,                    /* -mlong-calls */
  OPT_mlong32 = 1214,                        /* -mlong32 */
  OPT_mlong64 = 1215,                        /* -mlong64 */
  OPT_mlra = 1216,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1217,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1218,                           /* -mmad */
  OPT_mmadd4 = 1219,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1220,             /* -mmcount-ra-address */
  OPT_mmcu = 1221,                           /* -mmcu */
  OPT_mmemcpy = 1222,                        /* -mmemcpy */
  OPT_mmicromips = 1223,                     /* -mmicromips */
  OPT_mmsa = 1224,                           /* -mmsa */
  OPT_mmt = 1225,                            /* -mmt */
  OPT_mmusl = 1226,                          /* -mmusl */
  OPT_mnan_ = 1227,                          /* -mnan= */
  OPT_mno_float = 1228,                      /* -mno-float */
  OPT_mno_flush_func = 1229,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1230,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1231,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1232,                     /* -mno-mips3d */
  OPT_modd_spreg = 1233,                     /* -modd-spreg */
  OPT_mpaired_single = 1234,                 /* -mpaired-single */
  OPT_mplt = 1235,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1236,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1237,               /* -mrelax-pic-calls */
  OPT_mshared = 1238,                        /* -mshared */
  OPT_msingle_float = 1239,                  /* -msingle-float */
